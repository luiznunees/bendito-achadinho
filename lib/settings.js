...
const DEFAULTS = {
  ...
  AUTOPUBLISH_NO_REPEAT_DAYS: "3",
  AUTOPUBLISH_RANK_W_NICHE: "0.3",
  AUTOPUBLISH_RANK_W_SALES: "0.25",
  AUTOPUBLISH_RANK_W_DISCOUNT: "0.15",
  AUTOPUBLISH_RANK_W_COMMISSION: "0.05",
  AUTOPUBLISH_RANK_W_PRICE: "0.25",
  AUTOPUBLISH_SORT_TYPE: "5",
  AUTOPUBLISH_SEND_IMAGE: "true",
  AUTOPUBLISH_DRY_RUN: "false",
  AUTOPUBLISH_SPACING_MODE: "interval",
  AUTOPUBLISH_START_TIME: "08:00",
  AUTOPUBLISH_END_TIME: "23:00",
  AUTOPUBLISH_INTERVAL_MIN_MINUTES: "3",
  AUTOPUBLISH_INTERVAL_MAX_MINUTES: "15",
  AUTOPUBLISH_DAILY_TARGET: "15",
  AUTOPUBLISH_COUPON: "",
  ...
  AUTOPUBLISH_BLOCK_TERMS: "medusa,horus,ankh,olho de horus,buda,budismo,allah,islamica,islamico,maomé,maome,umbanda,espiritualismo,pachamama,satan,demonio,demônio,esqueleto,caveira,oculto,esoterico,esotérico,mágica,magica,energia,cristal,sandalia,rasteira,rasteirinha,chinelo,sapato,sapatilha,tenis,salto alto,marca texto,marca-texto,filho do rei,filha do rei",
  AUTOPUBLISH_TOKEN: "",
