...
async function runAutoPublish() {
  ...
  const sendImage = cfg("AUTOPUBLISH_SEND_IMAGE", "false").toLowerCase() === "true";
...
const GREETINGS_MORNING = [
  ...
  "☀️ Acordou? Então já tem oferta nova te esperando. Deus abençoe seu dia! 🙏",
  "☀️ Bom dia! Que hoje seja abençoado. Confere os achadinhos que separamos pra você! 🕊️",
  "☀️ Rise and shine! Dia novo, oferta nova. Deus abençoe! 🛍️",
];
...
const GREETINGS_NIGHT = [
  ...
  "🌙 Encerrando o expediente por hoje. Amanhã tem mais achadinho. Boa noite! 🕊️",
  "🌙 Boa noite! Que Deus guarde vocês. Amanhã voltamos com mais ofertas. 🛍️",
  "🌙 Foi um dia abençoado. Boa noite e até amanhã! 🕊️",
];
...
module.exports = { runAutoPublish, findOffersToPublish, buildGroupMessage, passesFilters, passesNicheFilter, runGreeting };
