...
// Títulos dos últimos `days` dias (qualquer origem: bot manual ou
// auto-publish) — usado pelo auto-publish para não repetir um produto
// de título muito parecido (ex.: mesma caneca/kit vindo de itemId
// diferente) mesmo quando o item em si nunca havia sido enviado antes.
async function getRecentTitles(days = 3) {
  const supabase = getClient();
